...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=23&duration=2800&pause=600&color=58A6FF&center=true&vCenter=true&width=560&lines=Full-Stack+Developer;TypeScript+%C2%B7+Python;From+idea+to+production;Open+to+new+opportunities" />
</p>

Full-stack developer focused on building **fast, reliable, and well-engineered products**. I work
across the entire stack — polished TypeScript frontends, Python services, PostgreSQL-backed APIs,
Docker-based deploys, and CI/CD that keeps shipping simple. I care deeply about clean code and
measurable results, and I ship until the details are right.

---

## Core Strengths

- **Full-stack ownership** — frontend to database, design system to deployment
- **Modern, typed code** — TypeScript everywhere the value earns it, Python for services & ML/AI
- **Product-minded** — I build with users in mind and iterate from real feedback
- **Own the shipping process** — Docker, GitHub Actions, Vercel, health checks included
- **Always leveling up** — currently deepening system design, scaling patterns, and AI integrations
...
<p align="center">
  <img src="https://streak-stats.demolab.com/?user=xeon405&theme=tokyonight&hide_border=true" />
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Open_to_opportunities-3FB950?style=flat-square&logo=checkmarx&logoColor=white" />
</p>
